Shader "CommonEffect/S_070_TruchetEnclosure"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f_img i): SV_Target
			{
				...
				/*
				fixed val = step((-tile.x + 0.4) + tile.y, 0.4) - step((-tile.x + 0.4) + tile.y, 0.3) +
				step((-tile.x + 0.6) + 2 * tile.y, 0.4) - step((-tile.x + 0.6) + 2 * tile.y, 0.3) +
				step((-tile.x + 0.6) + - tile.y + 0.6, 0.4) - step((-tile.x + 0.6) + - tile.y + 0.6, 0.3);
				*/
